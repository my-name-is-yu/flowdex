...
fn workflow_template(name: &str, max_agents: u64, phase_max_agents: u64, steps: &str) -> String {
    format!(
        r#"{{
...
fn parallel_review_template() -> String {
    ...
    },
    {
      ...
      "value": {
        ...
        "reviews": { "$result": "fanout:parallel-review" }
      }
    }"#,
    )
}
...
fn implementation_fanout_template() -> String {
    ...
    },
    {
      ...
      "id": "final",
      "value": {
        "title": "Implementation fanout",
        "plans": { "$result": "fanout:implementation-slices" }
      }
    }"#,
    )
}
